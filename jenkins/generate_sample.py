...
def open_pull_request(args) -> dict:
    ...
    body = "\n".join(
        [
            f"Pre-compiled dependency sample generated by the `generate-sample` Jenkins job.",
            "",
            "| | |",
            "|---|---|",
    ...
    request = urllib.request.Request(
        ...
        data=json.dumps({"title": title, "head": args.branch, "base": args.base, "body": body}).encode(),
        headers={
